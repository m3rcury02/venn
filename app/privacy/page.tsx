        ...
        <Panel>
          ...
          <div className="t-body mt-3 flex flex-col gap-3 text-[14px] text-fg-dim">
            ...
            <ul className="list-disc pl-5 flex flex-col gap-1.5">
              ...
              <li><strong className="text-fg">PostHog:</strong> Product analytics and error reports (hosted in the United States), as described in section 1. Error reports are sent to PostHog from our servers, not from your browser.</li>
