...
const chipBase =
  "t-label relative flex min-h-11 items-center rounded-ctl px-3 py-2 transition-colors motion-safe:active:scale-[0.97]";
const chipInactive = "bg-surface-2 text-fg-dim hover:text-fg active:text-fg";
